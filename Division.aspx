<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Division.aspx.cs" Inherits="AddProducts" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="col-md-11" style="padding-right: 7%">

                    <div class="alert alert-success ms-1 mt-2" role="alert" id="alertmsg" runat="server" visible="false">
                        <asp:Label ID="lblmsg" runat="server" Text=""></asp:Label>
                    </div>

                    <div class="card form-group mt-4 ms-2">
                        <div class="card-header" style="background-color: #fae1aeff">
                            <span class="ms-2">Division Master</span>
                        </div>

                        <div class="row mt-3 p-4 pt-2 justify-content-center ">
                            <div class="col-md-4">
                                <fieldset style="margin-top: -1%;">
                                    <legend class="text-dark fw-bold">Add Division</legend>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:Label Text="State Name" runat="server" CssClass="ms-2 fw-bold"></asp:Label><span style="color: red;">*</span>
                                            <asp:DropDownList runat="server" ID="ddlstate" CssClass="form-control mt-2 border-dark text-dark bg-body-tertiary "></asp:DropDownList>
                                            <asp:RequiredFieldValidator ErrorMessage="Plese Select state name" ControlToValidate="ddlstate" runat="server" ForeColor="Red" ValidationGroup="s" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <asp:TextBox runat="server" ID="txtdivname" placeholder=" Division Name" CssClass="form-control mt-2 border-black p-2"></asp:TextBox>
                                            <asp:RequiredFieldValidator ErrorMessage="Plese Enter Division name" ControlToValidate="txtdivname" runat="server" ForeColor="Red" ValidationGroup="s" />
                                        </div>
                                        <div class="row justify-content-center">
                                            <div class="col-md-9 text-center">
                                                <asp:Button Text="Submit" runat="server" ID="btn_submit" CssClass="btn btn-outline-success shadow px-3 mt-1" OnClick="btn_submit_Click" ValidationGroup="s" />
                                                &nbsp;
                                            <asp:Button Text="Clear" runat="server" ID="btn_clear" CssClass="btn btn-outline-danger shadow px-4 mt-1" />
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-8 text-center">
                                <fieldset style="margin-top: -1%">
                                    <legend style="margin-left: -40%" class="text-dark fw-bold">Division Details</legend>
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" ID="Division_grdDetails" AutoGenerateColumns="false" CssClass="table table-bordered border-dark-subtle " OnRowCommand="Division_grdDetails_RowCommand">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Division ID" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label Text='<%#Eval("Division_ID") %>' runat="server" ID="lbldivid"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Division Name">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                    <ItemTemplate>
                                                        <asp:Label Text='<%#Eval("Division_Name") %>' runat="server" ID="lbldivname"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Status">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnDivisionStatus" runat="server" CssClass='<%#  Eval ("Isactive").ToString()== "False" ? "btn btn-sm btn-danger" : "btn btn-sm btn-success" %>'
                                                            Text='<%# Eval ("Isactive").ToString()=="False" ? "Deactive" : "Active" %>'
                                                            CommandName="DivisionStatus" OnClientClick="return toggleRow(this);" CommandArgument='<%# Eval("Division_ID").ToString() %>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:LinkButton runat="server" CommandName="UpdateRecord" OnClientClick="return confirm('Are you sure you want to Update')" CommandArgument='<%# Eval("Division_ID") %>' CssClass="btn btn-sm btn-outline-warning">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                                        </asp:LinkButton>
                                                        &nbsp;
                                               <asp:LinkButton runat="server"
                                                   CommandName="DeleteRecord"
                                                   OnClientClick='<%# "toggleRow(\"row" + Eval("Division_ID") + "\"); return false;" %>'
                                                   CommandArgument='<%# Eval("Division_ID") %>'
